...
const About = () => {
  ...
  return (
    <section className="section about-section">
      ...
      {/* {visibleTechnicalSkills ? <h3  className="heading" onClick={() => setVisibleTechnicalSkills(!visibleTechnicalSkills)}>Hide</h3> : <h3 className="heading" onClick={() => setVisibleTechnicalSkills(!visibleTechnicalSkills)}>Click to see technical skills</h3>}
